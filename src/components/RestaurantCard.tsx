...
export function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded-[var(--radius-card)] bg-surface-primary shadow-card hover:shadow-card-hover transition-shadow overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-yellow focus-visible:ring-offset-2"
    ...
    >
      ...
      <div className="relative aspect-video overflow-hidden">
        ...
        <button
          ...
          className="absolute top-2 right-2 p-1.5 rounded-full bg-surface-primary/80 backdrop-blur-sm hover:bg-surface-primary transition-colors"
